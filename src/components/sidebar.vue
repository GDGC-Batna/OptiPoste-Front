     ...
     <div
      ...
      >
        ...
        <router-link
          ...
          :to="link.route"
          :class="[
            'flex items-center  transition-all duration-300 px-4 py-3',
        ...
        <!-- Logout Button -->
        <button class="text-red-600 hover:font-bold hover:underline flex items-center uppercase font-semibold space-x-2 px-4 py-3">
          <LogOut />
  ...
  data() {
    return {
      ...
      sidebarLinks: [
        ...
        { route: '/dashboard/product/create', label: 'All Files', icon: PackagePlus },
        ...
        { route: '/dashboard/settings', label: 'Bank statements', icon: Settings },
        { route: '/dashboard/settings', label: 'Official letters', icon: Settings },
